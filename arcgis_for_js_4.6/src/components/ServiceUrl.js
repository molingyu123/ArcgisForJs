export const ServiceUrl = {
  baseMap: 'http://192.168.1.211:6080/arcgis/rest/services/CD_SLServer/CD_BaseMap/MapServer', // 这里可以定义自己服务器上的底图的地址，也可以使用ArcGis提供的底图，详见Basemap类
  // apiUrl: 'https://js.arcgis.com/4.7/', // 使用官网提供的api，但是更建议使用离线部署的地址
